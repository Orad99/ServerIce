...
class ConnectionDock(QDockWidget):
    ...
    def push_button_click(self):
        # self.mc.publish_to(self.ePublisherTopic.text(), 'Dry-ice system button clicked')
        self.mc.publish_to("IOT_PROJECT_Relay", 'Dry-ice system button clicked')
...
class MainWindow(QMainWindow):
    ...
    def __init__(self, parent=None):
        ...
        self.setWindowTitle('Dry-ice system')
